...
namespace WebApiMetricsManager.Controllers
{
	...
	public class NetworkMetricsController : ControllerBase
	{
		...
		/// <summary>
		/// Get Network metrics (packets per second) at the specified time range from the agent with specified Id.
		/// </summary>
		/// <remarks>
		/// Request example:
		/// 
		/// 	GET api/metrics/network/agent/1/from/00.00:00:00/to/100000.00:00:00
		/// 
		/// </remarks>
		...
		/// <summary>
		/// Get Network metrics (packets per second) at the specified time range from all registered agents.
		/// </summary>
		/// <remarks>
		/// Request example:
		/// 
		/// 	GET api/metrics/network/cluster/from/00.00:00:00/to/100000.00:00:00
		/// 
		/// </remarks>
		/// <param name="fromTime">The start time (passed from 01.01.1970 00:00:00) of the time range.</param>
		/// <param name="toTime">The end time (passed from 01.01.1970 00:00:00) of the time range.</param>
